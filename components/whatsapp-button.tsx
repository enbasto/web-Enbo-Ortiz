...
export function WhatsAppButton() {
  ...
  const whatsappNumber = "573219316862" // Sin + ni espacios
  const message = "Hola Enbo, me interesa contactarte sobre tus aplicaciones."
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <div className="relative">
        ...
        >
          {/* <LucideWhatsapp className="h-6 w-6" /> */}
